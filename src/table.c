...
void table_put(uint64_t key, value_t value) {
    ...
    K_table[pos] = (key_t)key; // Store truncated key to detect some collisions.
    V_table[pos] = value;
}
